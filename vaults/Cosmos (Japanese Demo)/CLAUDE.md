# Vault Schema — Cosmos (Japanese Demo): an AI-generated, Japanese-language demonstration knowledge base on astronomy and the cosmos

This vault holds a compounding knowledge base on **Astronomy and the cosmos (Japanese-language demo)**, maintained
